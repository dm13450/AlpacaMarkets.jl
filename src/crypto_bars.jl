...
`timeframe::AbstractString`: 1Min-59min, 1Hour-23Hour
...
"""
function crypto_bars(symbol, timeframe::AbstractString; exchanges=nothing, startTime=nothing, limit=nothing, page_token=nothing)
  validate_ccy(symbol)
